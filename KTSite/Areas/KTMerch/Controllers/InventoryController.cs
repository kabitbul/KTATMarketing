...
namespace KTSite.Areas.KTMerch.Controllers
{
    ...
    public class InventoryController : Controller
    {
        ...
        public ActionResult GetList()
        {
            ...
            var allWeekOrders = _unitOfWork.Order.GetAll().Where(a => a.MerchId == uNameId && a.OrderStatus != SD.OrderStatusCancelled &&
            ...
            if (sortDirection == "desc")
            {
                ...
                else if (sortColumnName.ToLower() == "dailyavg3str")
                {
                    productList = productList.OrderByDescending(x => x.DailyAvg3).ToList<ProductInventory>();
                }
                else if (sortColumnName.ToLower() == "dailyavg7str")
                {
        ...
        {
            string uNameId = returnUserNameId();
            List<Product> allProducts = _unitOfWork.Product.GetAll().Where(a=>a.MerchId == uNameId).ToList();
