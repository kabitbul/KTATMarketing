...
namespace KTSite.Areas.Admin.Controllers
{
    ...
    public class AAmzInventoryGoralUSController : Controller
    {
        private readonly IUnitOfWork _unitOfWork;
        int gVarStoreId = SD.GoralStoreId;//---------GLOBAL CONST
        string gVarMarketplace = SD.marketPlaceUS;//--------GLOBAL CONST
        public AAmzInventoryGoralUSController(IUnitOfWork unitOfWork , IWebHostEnvironment hostEnvironment)
        {
