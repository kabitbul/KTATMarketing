...
namespace KTSite.Areas.Admin.Controllers
{
    ...
    public class AAmzInventoryKTCAController : Controller
    {
        private readonly IUnitOfWork _unitOfWork;
        int gVarStoreId = SD.KTStoreId;//---------GLOBAL CONST
        string gVarMarketplace = SD.marketPlaceCA;//--------GLOBAL CONST
        public AAmzInventoryKTCAController(IUnitOfWork unitOfWork , IWebHostEnvironment hostEnvironment)
        {
