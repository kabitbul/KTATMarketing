...
namespace KTSite.Areas.Admin.Controllers
{
    ...
    public class AAmzInventoryLitalUSController : Controller
    {
        private readonly IUnitOfWork _unitOfWork;
        int gVarStoreId = SD.LitalStoreId;//---------GLOBAL CONST
        string gVarMarketplace = SD.marketPlaceUS;//--------GLOBAL CONST
        public AAmzInventoryLitalUSController(IUnitOfWork unitOfWork , IWebHostEnvironment hostEnvironment)
        {
